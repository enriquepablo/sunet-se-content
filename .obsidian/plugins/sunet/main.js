...
var DEFAULT_SETTINGS = {
  stagingURL: "https://staging.sunet.se/refresh-content"
};
var fetchOptions = {
  method: "get",
  mode: "no-cors",
...
var SunetPlugin = class extends import_obsidian.Plugin {
  ...
  async commitPushAndFetch() {
    try {
      ...
      const response = await fetch(this.settings.stagingURL, fetchOptions);
  ...
  async hardResetForcePushAndFetch() {
    try {
      ...
      await this.git.push("origin", GIT_BRANCH, "--force");
